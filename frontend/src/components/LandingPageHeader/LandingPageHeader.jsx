...
const LandingPageHeader = () => {
  ...
  const { setShowSmallMenu, setShowContent, showSmallMenu } =
  ...
  return (
    ...
    >
      ...
      >
        {fullName !== " " && (
          <div style={{ paddingTop: "5px" }} className="landing-page-menu-icon">
            <MenuIcon
      ...
      <Grid item className="landing-page-Sign-icons">
        {fullName !== " " ? (
          <>
            ...
            >
              <span style={{ userSelect: "none", fontSize: "0.875rem" }}>
                Hi{" "}
              </span>
              ...
              >
                <HomeIcon style={{ cursor: "pointer", color: "#5375e1" }} />
              </Link>
            </div>
          </>
        ) : (
